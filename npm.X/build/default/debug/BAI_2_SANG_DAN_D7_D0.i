...
# 2 "<built-in>" 2
# 1 "BAI_2_SANG_DAN_D7_D0.c" 2
# 14 "BAI_2_SANG_DAN_D7_D0.c"
...
unsigned int tamLedPortC() {
    unsigned char total = 2, numberFlash = 5, numberRace = 2, numberCountUp = 3, pressed = 2;
